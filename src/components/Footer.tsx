        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm font-subtitle">
              <li><Link href="/" className="hover:text-brand-primary transition-colors">{t('nav.home')}</Link></li>
              <li><Link href="/gallery" className="hover:text-brand-primary transition-colors">{t('nav.gallery')}</Link></li>
              <li><Link href="/services" className="hover:text-brand-primary transition-colors">{t('nav.services')}</Link></li>
            </ul>
          </div>
          <div>
