...
const translations = {
  en: {
    ...
    "about.title": "About S&H Painting",
    "about.p1":
      "With years of experience in the industry, S&H Painting has built a reputation for excellence. We believe that a fresh coat of paint can do more than just change a color—it can revitalize a home or business, increase property value, and create an environment you love.",
    "about.p2":
    ...
    "service.interior.desc":
      "Transform your living spaces with our expert interior painting services. From walls and ceilings to trim and doors, we provide a flawless finish that reflects your style.",
    "service.exterior.title": "Exterior Painting",
    "service.exterior.desc":
      "Protect and beautify your property's exterior. Our durable finishes withstand the elements while giving your home or business a fresh, new look.",
    ...
    "video.subtitle":
      "Scroll to reveal the before and after of our premium painting services.",
    "video.before": "Before",
    "video.after": "After",
    "video.alt": "Before and after painting transformation animation",
    "common.logoAlt": "S&H Painting logo",
    "common.sealAlt": "S&H Painting brand seal",
  },
  es: {
    "nav.home": "Inicio",
    "nav.gallery": "Galería",
    ...
    "hero.description":
      "Pintura profesional residencial y comercial que da vida a su visión. Artesanía de calidad, atención al detalle y un acabado duradero.",
    "hero.cta1": "Nuestros Servicios",
    "hero.cta2": "Ver Galería",
    "about.title": "Sobre S&H Painting",
    "about.p1":
      "Con años de experiencia en la industria, S&H Painting ha construido una reputación de excelencia. Creemos que una capa fresca de pintura puede hacer más que solo cambiar un color: puede revitalizar un hogar o negocio, aumentar el valor de la propiedad y crear un ambiente que le encante.",
    "about.p2":
      "Nuestro equipo de profesionales calificados se dedica a brindar un servicio de primer nivel desde la consulta inicial hasta la inspección final. Utilizamos solo materiales de alta calidad y técnicas probadas para garantizar un acabado impecable en todo momento.",
    "about.cta": "Saber Más Sobre Nosotros",
    "testimonials.title": "Lo Que Dicen Nuestros Clientes",
    "testimonials.subtitle":
      "No solo tome nuestra palabra, escuche a nuestros clientes satisfechos.",
    "cta.title": "¿Listo para Comenzar su Proyecto?",
    "cta.description":
      "Contáctenos hoy para un presupuesto gratuito y traigamos algo de color a su mundo.",
    ...
    "services.footer.description":
      "Manejamos proyectos de todos los tamaños y tipos. Contáctenos para discutir sus requisitos específicos y obtener un presupuesto personalizado.",
    "services.footer.cta": "Contáctenos Hoy",
    "service.interior.title": "Pintura de Interiores",
    "service.interior.desc":
      "Transforme sus espacios de vida con nuestros servicios expertos de pintura de interiores. Desde paredes y techos hasta molduras y puertas, brindamos un acabado impecable que refleja su estilo.",
    "service.exterior.title": "Pintura de Exteriores",
    "service.exterior.desc":
      "Proteja y embellezca el exterior de su propiedad. Nuestros acabados duraderos resisten los elementos mientras le dan a su hogar o negocio un aspecto fresco y nuevo.",
    ...
    "common.logoAlt": "Logo de S&H Painting",
    "common.sealAlt": "Sello de marca de S&H Painting",
  },
};
